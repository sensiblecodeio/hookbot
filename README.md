...
If you're a ScraperWiki employee, you can use https://hookbot.sensiblecodeio.com.
...
```
$ wscat wss://token@hookbot.sensiblecodeio.com/sub/foo/bar
EVENT!
```
...
```
$ HOOKBOT_KEY=foo hookbot make-tokens --url-base https://hookbot.sensiblecodeio.com /pub/foo/bar
https://2e1150434ba1d8c33bce7c82ee08b5d9850342c7@hookbot.sensiblecodeio.com/pub/foo/bar
```
